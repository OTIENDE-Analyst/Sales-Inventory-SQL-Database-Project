...
2. SQL Operators;
3. SQL Joins
4. Subqueries(Number 51 - 60)
5. SQL Window functions (Number 61 -70)
6. Common Table Expresions in SQL (CTEs)( Number 71 - 80)
7. Advanced Analytical and Window functions analysis.(Number 81 - 100)
